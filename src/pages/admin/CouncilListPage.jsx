...
import LockComponent from "../../components/admin/LockComponent";
import CouncilDetailModel from "../../components/admin/LockComponent";
...
const CouncilListPage = () => {
    ...
    const notify = () => {
        toast.success('Đã thêm hội đồng!', {
            position: "top-center",
            autoClose: 1000,
                        ...
                        <div className="rounded-xl h-full shadow-lg shadow-slate-400 py-4 mx-4">
                            ...
                            <div className="grid grid-cols-2">
                                ...
                                <div className="flex justify-end mr-4">
                                    <button className="p-2 flex bg-green-700 text-white rounded-sm" onClick={() => setShowModal(true)}><IoMdAddCircleOutline className="mr-1 mt-1 text-lg" />Tạo hội đồng</button>
                                        ...
                                        <div className="p-2 text-left w-96">
                                            ...
                                            <form action="#">
                                                ...
                                                <div className="grid grid-cols-2 mt-2">
                                                    ...
                                                    <button className=" mx-2 py-2 bg-green-600 text-white rounded " onClick={() => { setShowModal(false); setRowCount(1); notify() }}>Lưu lại</button>
                                                </div>
                                            </form>
                                        </div>
                                    </Modal>
                                                    ...
                                                    <td className=" border-r-2 border-b-2  border-slate-400  py-2 flex justify-center">
                                                        <div>
                                                            {!lock ?
                                                                (
                                                                    <div>
                                                                        <button onClick={() => { setLockModal(true) }} className="bg-red-700 p-2 mr-2 text-white rounded-sm"><FaLock /></button>
                                                                        <LockComponent isVisible={lockModal}>
                                                                            ...
                                                                            <div className="grid grid-cols-2 mt-2">
                                                                                ...
                                                                                <button className=" mx-10 py-2 bg-green-600 text-white rounded " onClick={() => { setLock(true); setLockModal(false); notifyUnLock(); }}>Lưu lại</button>
                                                                            </div>
                                                                        </LockComponent>
                                                                    </div>
                                                                )
                                                                ...
                                                                (
                                                                    <div>
                                                                        <button onClick={() => setLockModal(true)} className="bg-green-700 p-2 mr-2 text-white rounded-sm"><FaLockOpen /></button>
                                                                        <LockComponent isVisible={lockModal}>
                                                                            <BsExclamationOctagonFill className="text-4xl text-yellow-400 m-auto animate-bounce " />
                                                                            ...
                                                                            <div className="grid grid-cols-2 mt-2">
                                                                                <button className=" mx-10 py-2 bg-gray-500 text-white rounded " onClick={() => setLockModal(false)}>Đóng</button>
                                                                                <button className=" mx-10 py-2 bg-green-600 text-white rounded " onClick={() => { setLock(false); setLockModal(false); notifyLock(); }}>Lưu lại</button>
                                                                            </div>
                                                                        </LockComponent>
                                                                    </div>
                                                                )}
                                                        ...
                                                        {/* <div>
                                                            <button className="bg-green-600 mr-2 p-2 text-white rounded-sm"><RxUpdate /></button>

                                                        </div> */}
                                                        <div>
                                                            <button onClick={() => CouncilDetail()} className="bg-sky-600 mr-2 p-2 text-white rounded-sm"><AiOutlineEye /></button>
                                                        </div>
                                                        <div>
                                                            <button className="bg-red-700 p-2 mr-2 text-white rounded-sm"><BsFillTrashFill /></button>
                                                            <CouncilDetailModel isVisible={remove}>
                                                                <BsExclamationOctagonFill className="text-4xl text-yellow-400 m-auto animate-bounce " />
