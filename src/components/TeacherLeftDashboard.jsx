...
import { HiOutlineDocumentCheck, HiDocumentText } from "react-icons/hi2";
        ...
        <div className="w-1/4 h-screen bg-blue-700">
            ...
            <div className="w-full">
                <ul>
                    ...
                    <li className=" text-white font-semibold text-xl hover:bg-blue-900">
                        <Link to="/admin/list/instructor" className="flex mx-5 py-2">
                            <div className="mt-2 mx-2 font-semibold text-3xl"><RiFileUserFill /></div>
                            <div className="mt-2 mx-2 font-semibold text-xl">Danh sách giảng viên hướng dẫn</div>
                        </Link>
                    </li>
                    <li className=" text-white font-semibold text-xl hover:bg-blue-900">
                    ...
                    <li className=" text-white font-semibold text-xl  hover:cursor-pointer">
                        <div className="flex px-5 py-2 hover:bg-blue-900" >
                            ...
                            <div className="mt-2 mx-2 font-semibold text-xl">Quản lý đề tài</div>
                            ...
                            <ul className="bg-blue-700 text-white ">
                                ...
                                <li className="py-2 hover:bg-blue-900 pl-10">
                                    <Link to="/admin/list/topic/processing" className="flex">
                                        <div className=" font-semibold text-3xl"><BsFileEarmark /></div>
                                        <div className="mx-2 font-semibold text-xl">Đang thực hiện</div>
                                    </Link>
                                </li>
                                <li className="py-2 hover:bg-blue-900 pl-10">
